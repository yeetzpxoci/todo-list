import { projects, createProject, currentProject, changeCurrentProject, createTodo} from "./app_logic";
...
function displayTodos() {
    for (let i = 0; i < currentProject.todos.length; i++) {
        ...
        todoName.innerHTML = currentProject[0].todos[i].title
        todoName.className = "todo-name";

        const due = document.createElement("p");
        due.innerHTML = currentProject[0].todos[i].dueDate
        due.className = "due";

        const descriptionText = document.createElement("p");
        descriptionText.id = "description-text";
        descriptionText.innerHTML = currentProject[0].todos[i].description;

import { projects, createProject, currentProject, changeCurrentProject, createTodo, removeTodo} from "./app_logic";
...
function displayTodos() {
    for (let i = 0; i < localStorage.getItem("currentProject").todos.length; i++) {
        ...
        todoName.innerHTML = localStorage.getItem("currentProject").todos[i].title
        todoName.className = "todo-name";

        const due = document.createElement("p");
        due.innerHTML = localStorage.getItem("currentProject").todos[i].dueDate
        due.className = "due";

        const descriptionText = document.createElement("p");
        descriptionText.id = "description-text";
        descriptionText.innerHTML = localStorage.getItem("currentProject").todos[i].description;
